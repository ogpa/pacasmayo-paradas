...
URL_BASE_REPORTE_PARADAS = "http://www.huntermonitoreoperu.com/GeoV3.3/Paginas/Recorrido.aspx?"
...
def reporte_unitario(id_placa, placa, cookie, fecha_inicio, fecha_fin):
    ...
    url = URL_BASE_REPORTE_PARADAS + \
        "ID=" + id_placa + "&P=" + placa + "&I=CUS&T=RRP&INI=" + fecha_inicio + \
        "%2000:00:00&FIN=" + fecha_fin + "%2023:00:59&PTO=0&MIN=0&CRI=1&FHS=0"
    ...
    url_Excel = url
    payload_Excel = '__EVENTTARGET=&__EVENTARGUMENT=&__VIEWSTATE=' + quote(vs_Response, safe="") + \
        '&__VIEWSTATEGENERATOR=' + quote(vsg_Response, safe="") + \
        '&__EVENTVALIDATION=' + quote(ev_Response, safe="") + '&txLatitudMapa=' + quote(txlat_Response, safe="") + '&txLongitudMapa=' + quote(txlon_Response, safe="") + '&txEA1=&txEA2=&txEA3=&txSteps=false&txMarcador=' + quote(txmarc_Response, safe="") + '&txMostrarCoordenadas=&hdpais=PE&txCapasAdicionales=&hdtiporeporte=RRP&hdservidorpe=http%3A%2F%2F190.223.20.10&hdservidorpex=http%3A%2F%2F190.223.20.10%3A8080&hdservidorcapaspe=http%3A%2F%2F190.223.20.10%3A8080&hdlistamapas=OS%2CGM%2CHUN%2CIOS&hdwuid=' + quote(hdwuid_Response, safe="") + '&hddistancia=&hdcluster=false&imgExcel.x=10&imgExcel.y=20&tbGrafico=%7B%26quot%3BactiveTabIndex%26quot%3B%3A0%7D&grdParadas=' + \
        quote(grdpar_Response, safe="") + '&txContador=53&txMaxRegistrosRecorrido=5000&txContadorPuntos=&vnMensajeState=%7B%26quot%3BwindowsState%26quot%3B%3A%26quot%3B0%3A0%3A-1%3A0%3A0%3A0%3A-10000%3A-10000%3A1%3A0%3A0%3A0%26quot%3B%7D&vnPuntosReferencialRState=%7B%26quot%3BwindowsState%26quot%3B%3A%26quot%3B0%3A0%3A-1%3A0%3A0%3A0%3A-10000%3A-10000%3A1%3A0%3A0%3A0%26quot%3B%7D&hdpuntos=&hdusuario=20605414410&hdnombreusuario=MB%2BRENTING%2BPACASMAYO&hdidusuario=93084&hdvid=' + \
        id_placa + '&hdcolumna=&hddesde=' + quote(fecha_inicio, safe="") + \
        '%2B00%3A00%3A00&hdhasta=' + quote(fecha_fin, safe="") + '%2B23%3A00%3A59&hdmotormapa=GM&txLatitudInicial=' + quote(txlatini_Response, safe="") + '&txLongitudInicial=' + quote(txlonini_Response, safe="") + \
...
def obtener_reporte_paradas(cookie, dict_placas_y_ids, lista_placa_cliente):
    ...
    for placa in lista_placa_cliente:
        ...
        ruta_archivo_paradas = reporte_unitario(
            id_placa, placa, cookie, fechas[0], fechas[1])
